Sparse Integrative Discriminant Analysis (SIDA) README
Dec 27, 2019
...
2. Please run examples_sida.m for examples. 


3. This Matlab package is for realizing the SIDA algorithm proposed in the following paper.
...
%--------------------------------------------------------------------------
%sida.m: function to perform sparse integrative disdcriminant analysis for fixed tuning parameters.
...
%also use sida.m  Tuning parameters are optimized over full grid or random grid.
...
%matrices. This function is called in SIDASimulationsTable2.m, SIDASimulationsTable3.m, 
%SIDASimulationsTable4.m, SIDANetSimulationsTable5.m for true discriminant
%solution vectors. 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%examples_sida.m: You can do the following:
% 1. Can load example simulated data: exampledata
% 2. Can use sida_cvRandom.m to obtain integrative discriminant vectors, estimated classificaition
